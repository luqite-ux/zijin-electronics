    ...
    <div data-motion-group className="grid gap-5 md:grid-cols-2">
      {productCategories.map((category) => (
        <Link
          ...
          className="motion-card group relative aspect-[4/3] overflow-hidden bg-[#171717] text-white shadow-[0_24px_60px_rgba(0,0,0,.14)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-red focus-visible:ring-offset-4"
        >
          <Image
            ...
            className="motion-media object-contain transition duration-700 group-hover:scale-[1.025]"
          />
